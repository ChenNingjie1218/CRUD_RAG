...
from src.llms import Qwen2_5_7B_Chat, Local_Chat, Qwen_14B_Chat
...
# class LocalQuestEval():
# class LocalQuestEval(Qwen2_5_7B_Chat):
# class LocalQuestEval(Local_Chat):
#     def __init__(self, model_name='Qwen/Qwen3-14B', temperature=1.0, max_new_tokens=1024, report=False, task_name='summary'):
#         super().__init__(model_name, temperature, max_new_tokens)
#         self.report = report
#         self.quest_gt_save = self._read_quest_gt(f'{task_name}_quest_gt_save.json')
